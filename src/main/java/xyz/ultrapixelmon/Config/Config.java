...
public class Config {
    ...
    public static Integer ChaiseMusicalHauteurMaxY;
    ...
    public static void load(){
        ...
        ChaiseMusicalHauteurMaxY = config.getInt("positionYHauteurMaxDeLaChaiseMusical",Configuration.CATEGORY_GENERAL, 9999, -9999, 9999, "Coordonnée Y maximum de la chaise musical");
